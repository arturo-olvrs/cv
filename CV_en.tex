...
\begin{minipage}[t]{5.8cm}
    ...
    \begin{minipage}[t]{5.2cm}
        ...
        {\scriptsize\textbf{\color{darktext} German:}} {\scriptsize\color{lightgray} B2 (Goethe-Zertifikat)}\\[1.5pt]
...
\begin{minipage}[t]{13.1cm}
    ...
    \timelineentry{B.Sc. in Computer Science and B.Sc. in Mathematics (Double Degree)}{2022 -- 2027}{%
        ...
        \begin{itemize}[leftmargin=*, nosep, topsep=1pt, itemsep=1.5pt]
            ...
            \item Specialization in Artificial Intelligence, Data Science, and Mathematical Optimization.
        \end{itemize}
    }
    ...
    \timelineentry{Erasmus+ Exchange \textbar\ Computer Science \& Data Science}{2025 -- 2026}{%
        ...
        \begin{itemize}[leftmargin=*, nosep, topsep=1pt, itemsep=1.5pt]
            \item International exchange; graduate-level coursework in computational modeling and AI.
        \end{itemize}
    }
    ...
    \timelineentry{Founder \& Lead Coordinator}{Sept. 2022 -- Present}{%
        ...
        \begin{itemize}[leftmargin=*, nosep, topsep=1pt, itemsep=1.5pt]
            ...
            \item Coordinate peer-learning dynamics, technical workshops, and algorithmic problem-solving sessions.
        \end{itemize}
    }
