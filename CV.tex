...
\begin{minipage}[t]{5.8cm}
    ...
    \begin{minipage}[t]{5.2cm}
        ...
        \begin{center}
            \begin{tikzpicture}
                \begin{scope}
                    % Aumentamos el radio a 1.3cm (diámetro = 2.6cm)
                    \clip (0,0) circle (1.3cm);
                    \node at (0,0) {\includegraphics[width=2.6cm, height=2.6cm, keepaspectratio=false]{avatar_temp.jpg}};
                \end{scope}
                % Borde circular ajustado al nuevo radio
